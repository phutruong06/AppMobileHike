...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void addNewCourse(String courseName, String courseDuration, String courseDescription, String courseTracks, String courseLength,String courseLevel, String courseParking) {
        ...
        values.put(LENGTH_COL, courseLength);
        values.put(LEVEL_COL, courseLevel);
        values.put(PARKING_COL, courseParking);
    ...
    public void updateCourse(String originalCourseName, String courseName, String courseDescription,
                             String courseTracks, String courseDuration, String courseLength,String courseLevel, String courseParking) {
